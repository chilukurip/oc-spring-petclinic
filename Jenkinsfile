...
"""
  ...
  environment {
    ...
    MATTERMOST_WEBHOOK = "https://mattermost.mgt.green.perspectatechdemos.com/hooks/mcqdbdzntprwppzijfbowoqqfc"
    ...
    BUILD_URL = "https://jenkins.mgt.green.perspectatechdemos.com/job/bogije/job/spring-petclinic/job/${BRANCH_NAME}/${BUILD_NUMBER}"
