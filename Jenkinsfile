...
"""
  ...
  environment {
    ...
    SONARQUBE_TOKEN = "de1904277166cca4dfab65b25277ef9868d72a3e"
    ...
    MATTERMOST_WEBHOOK = "https://mattermost.mgt.brown.perspectatechdemos.com/hooks/y3sh83mpcprepr71wid7mdyunr"
