...
"""
  ...
  environment {
    ...
    MATTERMOST_WEBHOOK = "https://mattermost.mgt.brown.perspectatechdemos.com/hooks/gggmksnr13buiys8tkouffteee"
    ...
    BUILD_URL = "https://jenkins.mgt.brown.perspectatechdemos.com/job/bogije/job/spring-petclinic/job/${BRANCH_NAME}/${BUILD_NUMBER}"
